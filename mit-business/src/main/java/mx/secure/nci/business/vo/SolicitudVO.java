...
public class SolicitudVO extends AbstractAuditoriaVO
{
	...
	private GenericCatalogoVO rechazoBanco;
	...
	private GenericCatalogoVO estatusTraspaso;
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("curp", curp).append("nss", nss)
				.append("clienteRfc", clienteRfc).append("periodo", periodo)
				.append("frecuenciaInicial", frecuenciaInicial)
				.append("frecuenciaFinal", frecuenciaFinal)
				.append("estatusSolicitud", estatusSolicitud)
				.append("fechaCargo", fechaCargo)
				.append("estatusCargo", estatusCargo)
				.append("rechazoBanco", rechazoBanco)
				.append("fechaCargaResp", fechaCargaResp)
				.append("fechaReactivacion", fechaReactivacion)
				...
				.append("intentos", intentos).append("moneda", moneda)
				.append("diversificaciones", diversificaciones)
				.append("medioNotificacion", medioNotificacion)
	...
	public GenericCatalogoVO getRechazoBanco() {
		return rechazoBanco;
	}
	public void setRechazoBanco(GenericCatalogoVO rechazoBanco) {
	...
	public GenericCatalogoVO getEstatusTraspaso() {
		return estatusTraspaso;
	}
	public void setEstatusTraspaso(GenericCatalogoVO estatusTraspaso) {
