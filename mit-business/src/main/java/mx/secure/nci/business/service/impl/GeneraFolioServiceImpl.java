...
import mx.secure.nci.business.service.IGeneraFolioService;
...
import mx.secure.nci.persistence.FolioPersistence;
import mx.secure.nci.persistence.GeneraFolioPersistence;
import secure.mx.iib.secure.conciliacion.conciliacionservice.v1.types.LiberarMovimientosReq;
import secure.mx.iib.secure.conciliacion.conciliacionservice.v1.types.LiberarMovimientosResp;
import secure.mx.iib.secure.conciliacion.conciliacionservice.v1.types.ListaCurp;
...
public class GeneraFolioServiceImpl implements IGeneraFolioService 
{
	...
	public int generaRegistroConciliacion(String folio, Short origen, Long numCtaInd, BigDecimal importe, String nombre,
		...
		concilFilter.setReferenciaSubcuentasecure(subctasecure);
