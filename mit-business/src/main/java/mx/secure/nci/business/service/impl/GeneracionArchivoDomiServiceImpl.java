...
import static mx.secure.nci.business.util.Constantes.DOMI_FILES_DATE_FORMAT_secure;
import static mx.secure.nci.business.util.Constantes.DOMI_FILES_DATE_FORMAT_BANCOMER;
import static mx.secure.nci.business.util.Constantes.FILE_NAME_EXT_DOMICILIACIONES_secure;
import static mx.secure.nci.business.util.Constantes.FILE_NAME_EXT_DOMICILIACIONES_BANCOMER;
import static mx.secure.nci.business.util.Constantes.FILE_NAME_OFFSET_DOMICILIACIONES_TRASPASO;
import static mx.secure.nci.business.util.Constantes.FILE_NAME_PART_DOMICILIACIONES_secure;
import static mx.secure.nci.business.util.Constantes.FILE_NAME_PART_DOMICILIACIONES_BANCOMER;
import static mx.secure.nci.business.util.Constantes.ID_secure_DOMICILIACIONES;
import static mx.secure.nci.business.util.Constantes.ID_BANCOMER_DOMICILIACIONES;
import static mx.secure.nci.business.util.Constantes.ID_ESTATUS_ARCHIVO_DOMI_GENERADO;
import static mx.secure.nci.business.util.Constantes.ID_ESTATUS_ARCHIVO_DOMI_EN_PROCESO;
import static mx.secure.nci.business.util.Constantes.ID_ESTATUS_ARCHIVO_DOMI_CANCELADO;
...
import static mx.secure.nci.business.util.Constantes.SPECIAL_CHARACTERS_REPLACERS;
import static mx.secure.nci.business.util.Constantes.BANCOMER_CONSECUTIVE_PADDING_POSITIONS;
import static mx.secure.nci.business.util.Constantes.secure_CONSECUTIVE_PADDING_POSITIONS;
import static mx.secure.nci.business.util.Constantes.DOMICILIACIONES_MONTO_MAXIMO_ENVIO_BANCO;
import static mx.secure.nci.business.util.Constantes.ID_CAT_CATALOGO_MONTO_MAXIMO_ENVIO_BANCO;
import static mx.secure.nci.business.util.Constantes.ID_UNICA_PARCIALIDAD;
import static mx.secure.nci.business.util.Constantes.ID_MAS_DE_UNA_PARCIALIDAD;
...
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_ESTATUS_CARGO_GENERADO;
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_ORIGEN_DOMICILIACION_TRASPASO;
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_OTROS_BANCOS_DOMI_FILE;
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_PROCESO_RECAUDACION;
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_SUBPROCESO_APORTACION_VOLUNTARIA;
import static mx.secure.nci.business.util.ConstantesCatalogos.ID_TIPO_MOVIMIENTO_ABONO;
...
import mx.secure.nci.business.file.generator.bean.secureDomiFixLenghtFileRecordBean;
import mx.secure.nci.business.file.generator.bean.secureDomiFixLenghtFileRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.secureDomiFooterRecordBean;
import mx.secure.nci.business.file.generator.bean.secureDomiHeaderRecordBean;
import mx.secure.nci.business.file.generator.bean.secureDomiHeaderRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.secureDomiRecordRecordBean;
import mx.secure.nci.business.file.generator.bean.secureDomiRecordRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.BancomerDomiFixLenghtFileRecordBean;
import mx.secure.nci.business.file.generator.bean.BancomerDomiFixLenghtFileRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.BancomerDomiFooterRecordBean;
import mx.secure.nci.business.file.generator.bean.BancomerDomiHeaderRecordBean;
import mx.secure.nci.business.file.generator.bean.BancomerDomiHeaderRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.BancomerDomiRecordRecordBean;
import mx.secure.nci.business.file.generator.bean.BancomerDomiRecordRecordBeanPar;
import mx.secure.nci.business.file.generator.bean.DataFileBean;
import mx.secure.nci.business.file.generator.service.IFileTransferService;
import mx.secure.nci.business.file.generator.service.IFilesGeneratorService;
import mx.secure.nci.business.service.ICatalogosService;
import mx.secure.nci.business.service.IGeneracionArchivoDomiService;
...
import mx.secure.nci.business.util.ControlHilos;
import mx.secure.nci.business.util.Hilo;
import mx.secure.nci.business.util.SolicitudFilterType;
...
import mx.secure.nci.business.wrapped.DomiParameterKeyFilter;
import mx.secure.nci.business.wrapped.DomiParameterMapFilter;
import mx.secure.nci.business.wrapped.DomiParameterValuesFilter;
...
import mx.secure.nci.persistence.CargoPersistence;
import mx.secure.nci.persistence.CatalogoPersistence;
import mx.secure.nci.persistence.DetalleArchivoDomiPersistence;
import mx.secure.nci.persistence.DiversificacionPersistence;
import mx.secure.nci.persistence.GeneraFolioPersistence;
import mx.secure.nci.persistence.SolicitudPersistence;
import secure.mx.iib.nci.bitacoraprocesos.folioservice.v1.FolioPortType;
import secure.mx.iib.nci.bitacoraprocesos.folioservice.v1.types.GenerarFolioReq;
import secure.mx.iib.nci.bitacoraprocesos.folioservice.v1.types.GenerarFolioResp;
import secure.mx.iib.nci.matrizconvivencia.matrizconvivenciaservice.v1.MatrizConvivenciaPortType;
import secure.mx.iib.nci.matrizconvivencia.matrizconvivenciaservice.v1.types.ConsultarConvivenciaReq;
import secure.mx.iib.nci.matrizconvivencia.matrizconvivenciaservice.v1.types.ConsultarConvivenciaResp;
...
//			addNOConvivenToSolFilter(solicitudFilter,noConviven);
			...
			if(insertCargos(domis, idArchivo, solicitudFilter.getUsuarioCreacion(), catDivPrioridades)) {
				try {
					if(ID_secure_NCI.equals(solicitudFilter.getIdTipoArchivo())){
						secureDomiFixLenghtFileRecordBeanPar bmxRecords =  mapVOTosecureRecordBean(domis, consecutivo, fecha, idArchivo);
						swPar = fileGeneratorService.generateFile(bmxRecords);
						LOGGER.info(swPar.getBuffer().toString());
						namePar.append(PATH_ACHIVO_DOMI_secure);
	...
	private void generarArchivoDomiF4(SolicitudFilter solicitudFilter,Date fecha,String archivo,Integer consecutivo, Short origenDomi) throws MitBusinessException{
		...
		Long idArchivo 												= null;
		secureDomiFixLenghtFileRecordBeanPar bmxRecords 			= null;
		...
		try{
			...
			if(insertCargosF4(domis, idArchivo, solicitudFilter.getUsuarioCreacion(), catDivPrioridades)) {
				try {
					...
					if(ID_secure_NCI.equals(solicitudFilter.getIdTipoArchivo())){									  
						bmxRecords =  mapVOTosecureRecordBeanF4(domis, consecutivo, fecha, idArchivo);
...
//				record.setReferenciaNumericaEmisor(referenciaNumericaEmisor);
	...
	private secureDomiFixLenghtFileRecordBeanPar  mapVOTosecureRecordBeanF4(List<SolicitudVO> solicitudes,Integer consecutivo, Date fecha, Long idArchivo){
			
			Integer numSeq									= null;
			secureDomiFixLenghtFileRecordBeanPar bean 		= null;
			secureDomiHeaderRecordBeanPar header 			= null;
			BigDecimal total 								= null;
			secureDomiFooterRecordBean footer 				= null;
			List<secureDomiRecordRecordBeanPar> records 	= null;
			
			try {
				
				numSeq	=	0;
				bean 	= new secureDomiFixLenghtFileRecordBeanPar();
				//Header 
				header	= new secureDomiHeaderRecordBeanPar();
				header.setDiaMes(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
				header.setConsecutivo(consecutivo);
				header.setNumSecuencia(++numSeq);
				header.setFechaPresentacion(fecha);
				...
				bean.setHeader(header);
				bean.setRecords(new ArrayList<secureDomiRecordRecordBeanPar>());
				total = new BigDecimal(0);
				
				for(SolicitudVO sol :solicitudes){
					try{
						records = getsecureRecordsF4(sol,fecha);
						for(secureDomiRecordRecordBeanPar record:records) {
				...
				footer = new secureDomiFooterRecordBean();
				footer.setDiaMes(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
				footer.setConsecutivo(consecutivo);
				footer.setNumeroOperaciones(numSeq-1);//Total de registros = numSeq -1 (Encabezado)
				footer.setNumeroSecuencia(++numSeq);
				...
				LOGGER.error( "ERROR UBICACIÓN     :" + GeneracionArchivoDomiServiceImpl.class.getCanonicalName() );
				LOGGER.error( "ERROR METODO        :" + "mapVOTosecureRecordBeanF4" );
				LOGGER.error( "ERROR MENSAJE       :" + e.getMessage() );
				LOGGER.error( "ERROR DESCRIPCIÓN   :" , e );
				return null;
			}finally {
	...
	//FOP 2229 Nuevos metodos
	private secureDomiFixLenghtFileRecordBeanPar  mapVOTosecureRecordBean(List<SolicitudVO> solicitudes,Integer consecutivo, Date fecha, Long idArchivo){
		Integer numSeq=0;
		secureDomiFixLenghtFileRecordBeanPar bean = new secureDomiFixLenghtFileRecordBeanPar();
		//Header 
		secureDomiHeaderRecordBeanPar header = new secureDomiHeaderRecordBeanPar();
		header.setDiaMes(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
		header.setConsecutivo(consecutivo);
		header.setNumSecuencia(++numSeq);
		header.setFechaPresentacion(fecha);
		...
		for(SolicitudVO sol :solicitudes){
			try{
				List<secureDomiRecordRecordBeanPar> records = getsecureRecords(sol,fecha);
				for(secureDomiRecordRecordBeanPar record:records) {
					total=total.add(record.getImporteOperacion());				
					record.setNumSecuencia(++numSeq);
					bean.getRecords().add(record);
		...
		secureDomiFooterRecordBean footer = new secureDomiFooterRecordBean();
		footer.setDiaMes(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
		footer.setConsecutivo(consecutivo);
		footer.setNumeroOperaciones(numSeq-1);//Total de registros = numSeq -1 (Encabezado)
		footer.setNumeroSecuencia(++numSeq);
	...
	private List<secureDomiRecordRecordBeanPar> getsecureRecordsF4(SolicitudVO sol, Date fecha) {
		
		List<secureDomiRecordRecordBeanPar> records 	= null;
		BigDecimal importe 								= null;
		List<BigDecimal> montosParciales 				= null;
		int numParcialidad 								= 0 ;
		secureDomiRecordRecordBeanPar record 			= null;
		String nombreCompleto 							= null;
		
		try {
			
			records 		= new ArrayList<secureDomiRecordRecordBeanPar>();
			importe 		= sol.getImporte();
			montosParciales = parcializaMontoF4(importe, Constantes.DOMICILIACIONES_MONTO_MAXIMO_ENVIO_BANCO);
			for(BigDecimal monto: montosParciales) {
				record = new secureDomiRecordRecordBeanPar();
				//record.setIdCargo(sol.getCargos().get(0).getIdCargo());
				record.setIdCargo(12);
				record.setNumParcialidad(++numParcialidad);
				record.setBancoReceptorClienteUsuario(sol.getClaveBanco().getId().intValue());
			...
			LOGGER.error( "ERROR UBICACIÓN    :" + GeneracionArchivoDomiServiceImpl.class.getCanonicalName() );
			LOGGER.error( "ERROR METODO       :" + "getsecureRecordsF4" );
			LOGGER.error( "ERROR MENSAJE      :" + e.getMessage() );
			LOGGER.error( "ERROR DESCRIPCIÓN  :" , e );
			return null;
		}finally {
	...
	private List<secureDomiRecordRecordBeanPar> getsecureRecords(SolicitudVO sol, Date fecha) {
		List<secureDomiRecordRecordBeanPar> records = new ArrayList<secureDomiRecordRecordBeanPar>();
		//if(sol.getCargos()!= null && !sol.getCargos().isEmpty()) {
			BigDecimal importe = sol.getImporte();
			List<BigDecimal> montosParciales = parcializaMonto(importe, Constantes.DOMICILIACIONES_MONTO_MAXIMO_ENVIO_BANCO);
			int numParcialidad = 0 ;
			for(BigDecimal monto: montosParciales) {
				secureDomiRecordRecordBeanPar record = new secureDomiRecordRecordBeanPar();
				//record.setIdCargo(sol.getCargos().get(0).getIdCargo());
				record.setIdCargo(12);
				record.setNumParcialidad(++numParcialidad);
				record.setBancoReceptorClienteUsuario(sol.getClaveBanco().getId().intValue());
	...
	private secureDomiFixLenghtFileRecordBean  mapVOTosecureRecordBean(List<SolicitudVO> solicitudes,Integer consecutivo, Date fecha){
		Integer numSeq=0;
		secureDomiFixLenghtFileRecordBean bean = new secureDomiFixLenghtFileRecordBean();
		//Header 
		secureDomiHeaderRecordBean header = new secureDomiHeaderRecordBean();
		header.setDiaMes(Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
		header.setConsecutivo(consecutivo);
		header.setNumSecuencia(++numSeq);
		header.setFechaPresentacion(fecha);
		...
		bean.setRecords(new ArrayList<secureDomiRecordRecordBean>());
		BigDecimal total = new BigDecimal(0);
		for(SolicitudVO sol :solicitudes){
			secureDomiRecordRecordBean record = new secureDomiRecordRecordBean();
			try{
				record.setBancoReceptorClienteUsuario(sol.getClaveBanco().getId().intValue());
				record.setFechaLiquidacion(fecha);
				record.setFechaVencimiento(fecha);
...
//			if(ID_secure_NCI.equals(type)){
//				SimpleDateFormat sdf = new SimpleDateFormat(DOMI_FILES_DATE_FORMAT_secure);
//				fileName .append(ID_secure_DOMICILIACIONES)
//					.append(sdf.format(fecha))
//					.append(FILE_NAME_PART_DOMICILIACIONES_secure)
//					.append(StringUtils.leftPad(
//								String.valueOf(consecutivo+FILE_NAME_OFFSET_DOMICILIACIONES_TRASPASO), 
//								secure_CONSECUTIVE_PADDING_POSITIONS,
//								'0')
//							)
//					.append(FILE_NAME_EXT_DOMICILIACIONES_secure);
...
//			throw mitBusinessException;
	...
	public Boolean validaConvivenciasecure(SolicitudVO solicitud){
	...
	@Transactional(rollbackFor = MitBusinessException.class, propagation = Propagation.REQUIRED)
	public Integer actualizarCargo(secureFilter filter) {
		int actualizacion = 0;
		try {
