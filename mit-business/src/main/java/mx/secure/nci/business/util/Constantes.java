...
public final class Constantes {
	...
	static{
		...
		PATH_ACHIVO_DOMI_secure =  getServerValue(WebSphereNamespace.MIT_NCI_AV_GEN_ARCHIVO_DOMI_secure_PATH);
		secure_REPOSITORIO_TESORERIA_DOMAIN = getServerValue(WebSphereNamespace.MIT_NCI_AV_secure_REPOSITORIO_TESORERIA_DOMAIN);
		secure_REPOSITORIO_TESORERIA_USERNAME = getServerValue(WebSphereNamespace.MIT_NCI_AV_secure_REPOSITORIO_TESORERIA_USERNAME);
		secure_REPOSITORIO_TESORERIA_PASSWORD = getServerValue(WebSphereNamespace.MIT_NCI_AV_secure_REPOSITORIO_TESORERIA_PASSWORD);
	...
	public static final String ID_secure_DOMICILIACIONES = "DCB";
	public static final String FILE_NAME_PART_DOMICILIACIONES_BANCOMER="_";
	public static final String FILE_NAME_PART_DOMICILIACIONES_secure="000106886951";
	public static final String FILE_NAME_EXT_DOMICILIACIONES_BANCOMER=".TXT";
	public static final String FILE_NAME_EXT_DOMICILIACIONES_secure=".DOM";
	public static final String DOMI_FILES_DATE_FORMAT_BANCOMER = "yyyyMMdd";
	public static final String DOMI_FILES_DATE_FORMAT_secure = "yyMMdd";
	...
	public static final Short secure_CONSECUTIVE_PADDING_POSITIONS = 2;
...
//	public static final String DOMI_FILES_DATE_FORMAT_TRASPASO = "ddMMyyyy";
	...
	public static final String PATH_ACHIVO_DOMI_secure;// = "smb://172.16.57.38/EGRESOS_ENVIO_BCOS/DOMICILIACION/PAF01/secure/";
	public static final String PATH_ACHIVO_DOMI_BANCOMER; //"smb://172.16.57.38/EGRESOS_ENVIO_BCOS/DOMICILIACION/PAF01/BBVA/"
	
	
	
    public static final String secure_REPOSITORIO_TESORERIA_DOMAIN;//="secure-GNP";
    public static final String secure_REPOSITORIO_TESORERIA_USERNAME;// = "RS998586";
    public static final String secure_REPOSITORIO_TESORERIA_PASSWORD;// = "PROLAT05**";
    //-------------------------------------------------------------
    ...
    public static final String OPERACION_FOLIO_WS_REQUEST_CIFRAR_DEVOLUCIONES_CIF = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:cip=\"http://secure.mx/iib/nci/retirossecure/cipherRA/\">\r\n" + 
    		"   <soapenv:Header/>\r\n" + 
    		"   <soapenv:Body>\r\n" + 
    		"      <cip:cifrar>\r\n" + 
