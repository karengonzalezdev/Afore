...
import secure.mx.iib.nci.identificacioncliente.clienteservice.v1.types.ConsultarClienteBasicoReq;
import secure.mx.iib.nci.identificacioncliente.clienteservice.v1.types.ConsultarClienteBasicoResp;
import secure.mx.iib.nci.identificacioncliente.clienteservice.v1.types.Identificadores;
import secure.mx.nci.modelo.Mensaje;
...
public class IdentificarClienteServiceImpl implements IIdentificarClienteService {
	...
	public ConsultarClienteBasicoResp consultarClienteBasico(final IdentificarClienteEnum identificador,
		...
		try {
			...
			secure.mx.iib.iibexception.iibexception.Error error = null;
