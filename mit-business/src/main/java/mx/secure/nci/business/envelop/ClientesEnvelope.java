package mx.secure.nci.business.envelop;
...
public class ClientesEnvelope {
	...
	public String envelopeAP_ResultadoDictamenRechazada(ResultadoDictamenRechazadoVO dictamen) {
		...
		try {
			...
			return "<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:v1='http://secure.mx/recaudacion/reclasificacionsecure/ValidarTramite/AP_ResultadoDictamenRechazada/v1'>"+
						"<soapenv:Header/>"+
							"<soapenv:Body>"+
	...
	public String envelopeContratoArchivosDomi (String idContrato) {
		try {
			...
			return "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:cat=\"http://catalogo.webservice.ws.nci.secure.mx/\">\r\n" + 
					"   <soapenv:Header/>\r\n" + 
					"   <soapenv:Body>\r\n" + 
					"      <cat:consultar>\r\n" + 
					"         <request>\r\n" + 
	...
	public String envelopeContratoFinalizacionArchDomi(String folio, String estatus) {
		...
		try {
			return "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dom=\"http://secure.mx/iib/nci/retiros/domiciliacion\">\r\n" + 
					"   <soapenv:Header/>\r\n" + 
					"   <soapenv:Body>\r\n" + 
