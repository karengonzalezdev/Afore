...
public class CifrasLiquidacionFilter  implements Serializable {
	...
	public CifrasLiquidacionFilter() {

	}
	
	public CifrasLiquidacionFilter(List<Short> estatusSolicitudes, List<Short> idsBancos,
			List<Short> idsTiposCuenta, Boolean flagOtrosBancos, Date fechaInicio, Date fechaFin, Short idTipoArchivo,
			List<Long> excludeNumCuentaIndividual, List<Short> subOrigen, Integer idConcil, String usuario,
			Long cuenta, Integer noCargo, String curp, Long nss) {
		...
		this.excludeNumCuentaIndividual = excludeNumCuentaIndividual;
	...
	public void setExcludeNumCuentaIndividual(List<Long> excludeNumCuentaIndividual) {
		this.excludeNumCuentaIndividual = excludeNumCuentaIndividual;
	}
