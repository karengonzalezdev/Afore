package mx.secure.nci.business.file.generator.service.impl;
...
import static mx.secure.nci.business.util.Constantes.secure_REPOSITORIO_TESORERIA_DOMAIN;
import static mx.secure.nci.business.util.Constantes.secure_REPOSITORIO_TESORERIA_USERNAME;
import static mx.secure.nci.business.util.Constantes.secure_REPOSITORIO_TESORERIA_PASSWORD;
	...
	public Boolean sendFile(StringBuffer sb, String sambaPath) throws IOException {
    	...
    	NtlmPasswordAuthentication auth = 
    			new NtlmPasswordAuthentication(
    					secure_REPOSITORIO_TESORERIA_DOMAIN, 
    					secure_REPOSITORIO_TESORERIA_USERNAME, 
    					secure_REPOSITORIO_TESORERIA_PASSWORD);
        SmbFile smb=null;
