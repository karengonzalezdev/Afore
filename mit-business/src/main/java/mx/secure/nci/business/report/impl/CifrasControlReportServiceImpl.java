...
import mx.secure.nci.business.report.beans.CifrasControlReclasecureDataReportBean;
import mx.secure.nci.business.report.beans.CifrasControlReclasecureDetalleMixToReportBean;
import mx.secure.nci.business.report.beans.CifrasControlReclasecureDetalleReportBean;
...
public class CifrasControlReportServiceImpl implements ICifrasControlReportService
{
    ...
    private static final String CIFRAS_CONTROL_RECLASIFICACION_REPORT_JRXML = "reports/reportessecure/cifrasControlReclasificacion.jrxml";
...
public ReporteVO generarArchivoCifrasCtrlReclasificacionsecure(
		CifrasControlReclasecureReportRequestReadEvent requestCifrasContrlEventVO) throws BusinessException {
		ReporteVO reporteVO = new ReporteVO();
		
		try {
			List<CifrasControlReclasecureDetalleReportBean> reporteRegistrosDataBean 	= new ArrayList<CifrasControlReclasecureDetalleReportBean>();
			List<CifrasControlReclasecureDetalleReportBean> totalesDataBean 			= new ArrayList<CifrasControlReclasecureDetalleReportBean>();
			List<CifrasControlReclasecureDetalleReportBean> cargosDataBean 				= new ArrayList<CifrasControlReclasecureDetalleReportBean>();
			List<CifrasControlReclasecureDetalleReportBean> abonosDataBean 				= new ArrayList<CifrasControlReclasecureDetalleReportBean>();
			List<CifrasControlReclasecureDetalleMixToReportBean> mixtoDataBean 			= new ArrayList<CifrasControlReclasecureDetalleMixToReportBean>();
			
			for (CCOrigDestReclasificacionVO origenDestinoVO : requestCifrasContrlEventVO.getReporteRegistrosVO()) {
				CifrasControlReclasecureDetalleReportBean cifCtrlReclaDetalleBean = new CifrasControlReclasecureDetalleReportBean();
			...
			CifrasControlReclasecureDetalleMixToReportBean totales	= new CifrasControlReclasecureDetalleMixToReportBean();
			
			List<String> subcuentasAux	= new ArrayList<String>();
			for( CifrasControlReclasecureDetalleReportBean aux : cargosDataBean ) {
				if( !subcuentasAux.contains( aux.getSubCuenta() ) ) {
					CifrasControlReclasecureDetalleMixToReportBean subcuenta	= new CifrasControlReclasecureDetalleMixToReportBean();
			...
			for( CifrasControlReclasecureDetalleReportBean aux : abonosDataBean ) {
				if( !subcuentasAux.contains( aux.getSubCuenta() ) ) {
					CifrasControlReclasecureDetalleMixToReportBean subcuenta	= new CifrasControlReclasecureDetalleMixToReportBean();
					subcuentasAux.add( 			aux.getSubCuenta() );
					subcuenta.setSubCuenta( 	aux.getSubCuenta() );
					...
					if( aux.getSubCuenta().equals( "TOTALES" ) ) {
						...
						for( CifrasControlReclasecureDetalleMixToReportBean existente: mixtoDataBean ) {
			...
			CifrasControlReclasecureDataReportBean cifrasCtrlDataBean = new CifrasControlReclasecureDataReportBean();
	    	...
	    	List<CifrasControlReclasecureDataReportBean> lstBean = new ArrayList<CifrasControlReclasecureDataReportBean>();
	    	lstBean.add(cifrasCtrlDataBean);
	
	    	BasicXLSParamReportBean<CifrasControlReclasecureDataReportBean> paramBean = new BasicXLSParamReportBean<CifrasControlReclasecureDataReportBean>();
			...
			MitBusinessException mitBusinessException = new MitBusinessException(
					GenerateExceptionDetails.generate(ErrorCodeService.EX_EXCEPTION, "En generar archivo",
							new Object[] { "CifrasControlReportServiceImpl", "generarArchivoCifrasCtrlReclasificacionsecure()" }, ex));
