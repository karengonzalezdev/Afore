...
import mx.com.secure_gnp.comun.catalogo.CatalogoComun;
import mx.com.secure_gnp.comun.catalogo.CatalogoComunService;
import mx.com.secure_gnp.ws.sso.controlacceso.ControlAccesoSSOPortType;
import mx.com.secure_gnp.ws.sso.controlacceso.ControlAccesoSSOService;
import mx.secure.ldap.operacionesldap.OperacionesLdapService;
import mx.secure.ldap.operacionesldap.OperacionesLdapServices;
import mx.secure.nci.business.util.NameSpaceBindingProvider;
import mx.secure.nci.business.util.WebSphereNamespace;
import mx.secure.nci.ws.webservice.catalogo.impl.ICatalogoSoapWS;
import mx.secure.nci.ws.webservice.catalogo.impl.ICatalogoSoapWSService;
import mx.secure.nci.ws.webservice.indicadores.impl.IIndicadoresSoapWS;
import mx.secure.nci.ws.webservice.indicadores.impl.IIndicadoresSoapWSService;
import secure.mx.iib.secure.conciliacion.conciliacionservice.v1.ConciliacionPortType;
import secure.mx.iib.secure.conciliacion.conciliacionservice.v1.ConciliacionService;
import secure.mx.iib.secure.domiciliaciones.domiciliacionservice.v1.DomiciliacionPortType;
import secure.mx.iib.secure.domiciliaciones.domiciliacionservice.v1.DomiciliacionService;
import secure.mx.iib.certif.certificaciones.cuentascertificadasservice.v1.CuentasCertificadasPortType;
import secure.mx.iib.certif.certificaciones.cuentascertificadasservice.v1.CuentasCertificadasService;
import secure.mx.iib.nci.bitacoraprocesos.folioservice.v1.FolioPortType;
import secure.mx.iib.nci.bitacoraprocesos.folioservice.v1.FolioService;
import secure.mx.iib.nci.identificacioncliente.clienteservice.v1.ClientePortType;
import secure.mx.iib.nci.identificacioncliente.clienteservice.v1.ClienteService;
import secure.mx.iib.nci.matrizconvivencia.matrizconvivenciaservice.v1.MatrizConvivenciaPortType;
import secure.mx.iib.nci.matrizconvivencia.matrizconvivenciaservice.v1.MatrizConvivenciaService;
