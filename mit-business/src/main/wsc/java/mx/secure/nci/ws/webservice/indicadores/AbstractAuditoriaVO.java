...
/**
 * <p>Clase Java para abstractAuditoriaVO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="abstractAuditoriaVO">
 *   &lt;complexContent>
...
@XmlType(name = "abstractAuditoriaVO", propOrder = {
    "fechaActualizacion",
    "fechaCreacion",
...
@XmlSeeAlso({
    ConfiguracionIndicadorVO.class
})
