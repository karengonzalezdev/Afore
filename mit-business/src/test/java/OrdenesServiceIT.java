...
public class OrdenesServiceIT 
{
	...
	private void guardar()
	{
		...
		try 
		{
			...
			diverOrdenesVO_1.setFondosecure(new GenericCatalogoVO(new Short("741")));
...
//			diverOrdenesVO_1.setPorcentaje(new Short("50"));
			...
			diverOrdenesVO_2.setFondosecure(new GenericCatalogoVO(new Short("742")));
...
//			diverOrdenesVO_3.setFondosecure(new GenericCatalogoVO(new Short("742")));
...
//			diverOrdenesVO_3.setUsuarioCreacion(usuarioCreacion);
			...
			diverOrdenesVO_4.setFondosecure(new GenericCatalogoVO(new Short("743")));
	...
	private void update()
	{
		...
		try 
		{
			...
			DiversificacionOrdenesVO diverOrdenesVO_3=new DiversificacionOrdenesVO();
			diverOrdenesVO_3.setNumeroOrden(numeroOrden);
			diverOrdenesVO_3.setFondosecure(new GenericCatalogoVO(new Short("743")));
			...
			DiversificacionOrdenesVO diverOrdenesVO_4=new DiversificacionOrdenesVO();
			diverOrdenesVO_4.setNumeroOrden(numeroOrden);
			diverOrdenesVO_4.setFondosecure(new GenericCatalogoVO(new Short("745")));
