...
//			conciliacionVO.setReferenciaSubcuentasecure(66);
...
//			conciliacionVO.setApellidoClientePaterno("Lopez");
			...
			conciliacionVO.setFechaPagosecure(new Date());
			conciliacionVO.setFechaValorsecure(new Date());
			...
			diver_1.setFondosecure(new GenericCatalogoVO(new Short("741")));
			...
			diver_2.setFondosecure(new GenericCatalogoVO(new Short("742")));
			...
			diver_3.setFondosecure(new GenericCatalogoVO(new Short("743")));
