...
public class CatalogoConfigVO extends AbstractAuditoriaVO
{
	...
	private GenericCatalogoVO subctaApovol;
	...
	public GenericCatalogoVO getSubctaApovol() {
		return subctaApovol;
	}

	public void setSubctaApovol(GenericCatalogoVO subctaApovol) {
	...
	public String toString() {
		return "PrincipalVO [idConciliacion=" + idConciliacion + ", folio=" + folio + ", cveSolicitud=" + cveSolicitud
				...
				+ ", subctaApovol=" + subctaApovol + ", fechaCargaArchivo=" + fechaCargaArchivo + ", nombre="
				+ nombre + ", apPaterno=" + apPaterno + ", apMaterno=" + apMaterno + ", curp=" + curp + ", rfc=" + rfc
				+ ", nss=" + nss + ", correo=" + correo + ", celular=" + celular + ", empresa=" + empresa
				+ ", tipoNomina=" + tipoNomina + ", noEmpleado=" + noEmpleado + ", fechaPagoApovol="
				+ fechaPagoApovol + ", fechaValorApovol=" + fechaValorApovol + ", folioTransaccion=" + folioTransaccion
