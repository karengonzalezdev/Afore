...
public class BancomerDomiHeaderRecordBeanPar {
	private static final byte ZERO = (byte)'0';
	private static final String RAZON_SOCIAL_PROFUTURO = "PROFUTURO AFORE SA DE CV";
	private static String RFC_EMISOR="PGA-961220PB4";
...
//	private Integer	numBloque;
	...
	@Field(at=100,length=18,align=Align.LEFT)
	...
	public BancomerDomiHeaderRecordBeanPar () {
	}
	
	public BancomerDomiHeaderRecordBeanPar (String RFC_EMISOR) {
		this.RFC_EMISOR = RFC_EMISOR;
		this.rfcEmisor = RFC_EMISOR;
	}
