...
public class BanamexDomiFooterRecordBean {
...
//	@Field(at=11,length=7,padding=ZERO,align=Align.RIGHT)
//	private Integer numeroBloque;
	...
	@Field(at=18,length=7,padding=ZERO, align=Align.RIGHT)
	...
	private String usoFuturoBanamex1;
	
	@Field(at=60,length=240,align=Align.RIGHT)
	private String usoFuturoBanamex2;
	
	@Field(at=300,length=100,align=Align.RIGHT)
	private String usoFuturoBanamex3;
