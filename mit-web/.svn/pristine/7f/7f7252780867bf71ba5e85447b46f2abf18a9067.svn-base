...
g_l["MONTH_FWD"] = " Mover un mes hacia adelante";
g_l["MONTH_BCK"] = "Mover un mes atr�s";
g_l["YEAR_FWD"] = "Mover un a�o hacia adelante";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.cellColorScheme = "ocean_blue";
	this.oConfiguration.dateFormat		= (aConf["dateFormat"] != null) ? aConf["dateFormat"] : "%m-%d-%Y";
	this.oConfiguration.imgPath			= "../img/";
