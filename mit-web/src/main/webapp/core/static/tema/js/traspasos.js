...
$(function() {
   ...
   $(document).ready(function(){
    ...
    //Ejemplo Iniciar Tramite document.getElementById('formAjaxSoliitar:nss').placeholder="(10 d�gitos: clave lada y n�mero telef�nico)";
         ...
         //   var value = $('input[id="regimen:0"]:checked').val();
           //  var ambos = $('input[id="regimen:2"]:checked').val();
            if(value == true) {            	
                ...
                document.getElementById('form-solicita:nss').required=true;
                //document.getElementById('formAjaxSoliitar:nss').placeholder="(10 d�gitos: clave lada y n�mero telef�nico)";
            } else if((ambos  == true)){
            	 $('.dnss').show();
                //document.getElementById('bloquea').style.display="block";
                document.getElementById('form-solicita:nss').value="";
