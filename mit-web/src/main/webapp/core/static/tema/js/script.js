	...
	switch($(this).attr("layout")) {
		...
		case "720":
            ...
            if( $(".central-afore").length == 0 ) {
                $(".main").append("<div class='central-afore'><p style='padding-top: 2px;'><a class='cambio-iframe' href='http://miretirosecure.com/cambiate/cambio_de_afore.php' target='_blank' style='font-size: 1.2em;'><span>C�mbiate a</span> AFORE secure</a></p></div>");
            }
            $(document).mouseup(function(){
                if($("#log-button").length!=0){
                    $("#loginbox").hide();
...
$(document).ready(function () {
    ...
    $('#duda').change(function(){
        window.location = 'https://www.secure.mx/content/wps/portal/ayuda/'+$(this).val();
