...
import mx.secure.nci.web.beans.ConsultaDetalleAforeMovilBean;
import mx.secure.nci.web.beans.GenericCatalogoBean;
import mx.secure.nci.web.service.IMonitoreoAforeMovilWebService;
...
IMonitoreoAforeMovilWebService {
	...
	public List<ConsultaAforeMovilBean> consultarMovimientosAforeMovil(String filtroVal, String filtro, 
		...
		for(ConciliacionVO concilVo : lstRegistros){
			...
			consulBean.setPrimerAportacion(concilVo.getFechaPagosecure() != null ? concilVo.getFechaPagosecure() : null);
			...
			det.setFechaConciliacion(concilVo.getFechaValorsecure() != null ? concilVo.getFechaValorsecure() : null);
	...
	public int insertaRegistroConciliacion(String folio, Short origen, Long numCtaInd, BigDecimal importe, String nombre,
		...
		return generaFolioService.generaRegistroConciliacion(folio, origen, numCtaInd, importe, nombre, apPaterno, apMaterno, curp, 
				                                             rfc, nss, correo, celular, usuario, subctasecure);
	}
