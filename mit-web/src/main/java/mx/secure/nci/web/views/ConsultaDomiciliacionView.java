...
public class ConsultaDomiciliacionView implements Serializable{
	...
	private DetalleSpeisecure detalleSpei;
...
//			}
			...
			if(selectedSolicitud.getOrigenSolicitud().getId().equals(new Short("292"))){
				DetalleSpeisecure detSpei = consultaDomiciliacionWebService.obtenerDetalleSpei(selectedSolicitud.getFolio());
				detSpei.setEmpresa("");
				...
				DetalleSpeisecure detSpei = consultaDomiciliacionWebService.obtenerDetalleNomina(selectedSolicitud.getFolio(),selectedSolicitud.getNumCuentaIndividual());
				setDetalleSpei(detSpei);
			}
		}
	...
	public DetalleSpeisecure getDetalleSpei() {
		return detalleSpei;
	}

	public void setDetalleSpei(DetalleSpeisecure detalleSpei) {
