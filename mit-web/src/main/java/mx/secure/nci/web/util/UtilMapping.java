...
//		vo.setBanco(banco);
	...
	public static secure_CIFVo mapPCIFBeanToVO(NCI_CIFDataBean bean) {
		secure_CIFVo vo = new secure_CIFVo();
	...
	public static List<secure_CIFVo> mapListPCIFBeanToVO(List<NCI_CIFDataBean> beans){
		List<secure_CIFVo> vos = new ArrayList<secure_CIFVo>();
