...
import mx.secure.nci.web.beans.MovimientosCIFParamBean;
...
//		regeneraIdItem();
	...
	public void send2CIF() {
		try {
			List<secure_CIFVo> sended = UtilMapping.mapListPCIFBeanToVO(paramBean.getCuentasAenviar());
	...
	public void getReportPrev() {
		try {
			List<secure_CIFVo> reportePrev = UtilMapping.mapListPCIFBeanToVO(paramBean.getCuentasAenviar());
